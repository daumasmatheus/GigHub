...
namespace GigHub.Tests.Persistence.Repositories
{
    ...
    public class GigRepositoryTests
    {
        ...
        [TestMethod]
        public void GetUpcomingGigsByArtist_GigsIsForADiferentArtist_ShouldNotBeReturned()
        {
            var gig = new Gig() { DateTime = DateTime.Now.AddDays(1), ArtistId = "1" };
        ...
        [TestMethod]
        public void GetUpcomingGigsByArtist_GigIsForTheGivenArtistAndIsInTheFuture_ShouldReturn()
        {
            var gig = new Gig() { DateTime = DateTime.Now.AddDays(1), ArtistId = "1" };
        ...
        [TestMethod]
        public void GetGigUserAttending_GigIsInThePast_ShouldntBeReturned()
        {
        ...
        [TestMethod]
        public void GetGigsUserAttending_UserIsNotAttendingTheGig_ShouldntBeReturned()
        {
            var gig = new Gig() { DateTime = DateTime.Now.AddDays(1) };
            var attendance = new Attendance() {Gig = gig, AttendeeId = "1"};
        ...
        [TestMethod]
        public void GetGigsUserIsAttending_UserIsAttendingTheGig_ShouldReturn()
        {
            var gig = new Gig() { DateTime = DateTime.Now.AddDays(1) };
            var attendance = new Attendance() {Gig = gig, AttendeeId = "1" };
